...
tema_BSPN <- function(){
    ...
    theme(
      ...
      axis.text = element_text(family = "Open Sans", colour = "grey20"),
      title = element_text(face = "bold", size = 10),
      plot.subtitle = element_text(face = "plain", family = "Open Sans Condensed", size = 10),
...
plot_funcoes <- function(funcao){
  ggplot(
    ...
    labs(
      ...
      y = NULL,
      fill = "Ente",
      title = paste("Despesas com ", tolower(funcao), " por ente da Federação ","2002\u2013","2017", sep=""),
