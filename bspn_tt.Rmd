...
plot_funcoes <- function(funcao){
  ggplot(
    ...
    scale_y_continuous(labels = scales::percent) +
    scale_fill_manual(values = tres_cores) +
    geom_text(aes(label= scales::percent(Valor, 0.1)),size = 2.2, position = position_stack(vjust = 0.5), hjust = 0.5, family = "Calibri", color = "white") +
...
ggsave("saude_barra.png", lista_grafBarras[[2]], dpi = 400, type = "cairo-png", width = 8, height = 5)
ggsave("saude_linha.png", lista_grafLinhas[[2]], dpi = 400, type = "cairo-png", width = 8, height = 5)
